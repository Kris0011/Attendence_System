...
if($currenttime < $time){
    echo "The lecture has not started yet. you will be redirected back to dashboard in 5 sec.";
    sleep(5);
...
<body>
    ...
    <form action="check_attendence_teacher.php" method="post" class="p-4 bg-light rounded">
    ...
    <h3 id="message" class="mb-3 text-center" style="display: none;">Attendance in progress. Please wait for 5 min and
        do not close this page in the mean time.</h3>
